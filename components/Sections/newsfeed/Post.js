...
//   return (
//     <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 justify-content-center mt-2">
//       <div className="col bg-white border rounded p-2" id={`post${data._id}`}>
//         <div className="">
//           <div className="d-flex justify-content-between py-1 px-3 px-sm-3">
...
//                 <Link passHref href={`/profile/${data._id}`}>
//                   <a
//                     className="mt-1 text-dark"
//                     style={{ textDecoration: "none" }}
//                   >
//                     {`${data.author_name.firstName} ${data.author_name.lastName}`}
//                   </a>
//                 </Link>
...
//         </div>
//         <div className="px-3">
//           {data.post?.text && <p className="px-1">{data.post.text}</p>}
//           {data.post?.images && (
//             <img
//               src={data.post.images[0]}
//               alt={data.author_name.firstName}
//               width="100%"
//               className="px-2"
...
//               <a
//                 role="button"
//                 onClick={(e) => getLikers(e)}
//                 data-post-id={search._id}
//                 data-bs-toggle="modal"
//                 data-bs-target={`#modal${search._id}`}
//                 className="text-muted "
//                 style={{ textDecoration: "none" }}
//               >
//                 <span
//                   className="bi bi-hand-thumbs-up text-primary pe-2"
//                   style={{ pointerEvents: "none" }}
//                 ></span>
//                 {search.reactions?.likes?.liker?.length}
//               </a>
//               <div>
//                 <a
//                   role="button"
...
//                   style={{ textDecoration: "none" }}
//                 >
//                   <span className="pe-0 pe-sm-2">
//                     {search.reactions?.comments?.commentators?.length}
//                   </span>{" "}
//                   Comment
//                 </a>
//                 <a
...
//               {search.reactions?.likes?.liker?.find(
//                 (t) => t === currentUser._id
//               ) ? (
//                 <button
//                   data-post-id={i._id}
...
//                   style={{ textDecoration: "none" }}
//                 >
//                   <span className="bi bi-hand-thumbs-up-fill pe-2"></span> Liked
//                 </button>
//               ) : (
//                 <button
...
//                   style={{ textDecoration: "none" }}
//                 >
//                   <span className="bi bi-hand-thumbs-up pe-2"></span> Like
//                 </button>
//               )}

//               <button
//                 data-post-id={search._id}
//                 onClick={() => commentInp.current.focus()}
//                 className="btn text-dark"
//                 style={{ textDecoration: "none" }}
//               >
//                 <span className="bi bi-chat pe-2"></span> Comment
//               </button>
//               <button
//                 className="btn text-dark"
//                 style={{ textDecoration: "none" }}
...
//                       {comments[0].user[
//                         comments[0].user.findIndex((t) => t._id === i.user_id)
//                       ].image && (
//                         <img
//                           src={
//                             comments[0].user[
//                               comments[0].user.findIndex(
//                                 (t) => t._id === i.user_id
//                               )
//                             ].image
//                           }
...
//                       >
//                         <p className="text-muted text-start p-0 m-0">
//                           <Moment fromNow interval={1000}>
//                             {i.time}
//                           </Moment>
//                         </p>
...
//                   data-btn-id={`commentbtn${i._id}`}
//                   data-spinner-id={`spinner${i._id}`}
//                   data-post-id={i._id}
//                 >
...
//               tabIndex="-1"
//               aria-labelledby={`modal${i._id}Label`}
//               aria-hidden="true"
//             >
...
//                         <span className="bi bi-hand-thumbs-up-fill text-primaty me-2"></span>
//                       </h3>
//                     </div>
//                     <button
//                       type="button"
...
//               data-bs-keyboard="false"
//               tabIndex="-1"
//               aria-labelledby={`del${i._id}Label`}
//               aria-hidden="true"
//             >
